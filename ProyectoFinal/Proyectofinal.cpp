...
float	posX = 0.0f,
		...
		movBrazIzq = 0.0f,
		movCabeza = 0.0f,
		incX = 0.0f,	//Calculo del incremento
		incY = 0.0f,
		incZ = 0.0f,
		rotInc = 0.0f,
		rotDer = 0.0f,
...
int main()
{
	...
	"Textures/Skybox/sp2_rt_dia.png",
	"Textures/Skybox/sp2_lf_dia.png",
	"Textures/Skybox/sp2_dn_dia.png",
	"Textures/Skybox/sp2_up_dia.png",
	"Textures/Skybox/sp2_bk_dia.png",
	"Textures/Skybox/sp2_ft_dia.png"
	};

	std::vector<std::string> skyboxFacesNoche = {
		"Textures/Skybox/sp2_rt_noche.png",
		"Textures/Skybox/sp2_lf_noche.png",
		"Textures/Skybox/sp2_dn_noche.png",
		"Textures/Skybox/sp2_up_noche.png",
		"Textures/Skybox/sp2_bk_noche.png",
		"Textures/Skybox/sp2_ft_noche.png"
	};
	...
	//--------------------------------------------------------------------------------
		...
		//MONEDA
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.0f, movMoneda));
		...
		case 0:
			...
			if (zTranslate < maxZDistance) {
				zTranslate += 0.5f; // Ajusta la velocidad según tus necesidades
			}
			else {
				estadoMovimiento = 1;
			}
		...
		case 1:
			...
			if (xTranslate > -maxXDistance) {
				...
				zTranslate += 0.2f; // Ajusta la cantidad de desplazamiento en Z para lograr la inclinación
			}
			else {
				estadoMovimiento = 2;
			}
		...
		// Crear y aplicar la matriz de modelo con el desplazamiento en los ejes Z y X
		model = glm::mat4(1.0);
